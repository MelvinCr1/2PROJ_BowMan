...
class CustomizationScene:
    def __init__(self, screen):
        ...
        # Chargement images de style sans redimensionner
    ...
    def draw(self):
        ...
        # Changement de la couleur de la case à cocher si l'option d'obstacle est activée
        if self.obstacle_option:
            self.checkbox_color = (0, 255, 0)  # verte
        else:
            self.checkbox_color = (255, 255, 255)  # blanche
